...
export const fetchedAt = "2026-06-03T13:53:45.908Z";
    ...
    "associatedPullRequests": [
      {
        "number": 11,
        "state": "MERGED",
        "url": "https://github.com/Eric900614/ejwf/pull/11"
      }
    ]
  },
  {
    ...
    "associatedPullRequests": [
      {
        "number": 13,
        "state": "MERGED",
        "url": "https://github.com/Eric900614/ejwf/pull/13"
      }
    ]
  }
];
export const adrDocuments: ResolvedAdrReference[] = [
  {
    "code": "ADR-0001",
    "number": "0001",
    "path": "docs/adr/0001-no-github-projects-labels-as-source-of-truth.md",
    "title": "驾驶舱不接 GitHub Projects；标签 + 正文为阶段与依赖的权威来源",
    "url": "https://github.com/Eric900614/ejwf/blob/main/docs/adr/0001-no-github-projects-labels-as-source-of-truth.md"
  },
  {
    "code": "ADR-0002",
    "number": "0002",
    ...
    "url": "https://github.com/Eric900614/ejwf/blob/main/docs/adr/0002-local-app-not-hosted-web.md"
  },
  {
    "code": "ADR-0003",
    "number": "0003",
    "path": "docs/adr/0003-cockpit-defaults-to-open-cards.md",
    "title": "驾驶舱默认只显示 open 卡；已完成卡退为可选的灰色背景",
    "url": "https://github.com/Eric900614/ejwf/blob/main/docs/adr/0003-cockpit-defaults-to-open-cards.md"
  },
  {
    "code": "ADR-0004",
    "number": "0004",
